...
urlpatterns = [
    ...
    path('hospitaldepartmentsHospital/<str:hospitalEmail>/', HospitalDepartmentsViewHospital.as_view(), name='hospital_departments'),
    ...
    path('doctors/', UIDoctorListView.as_view(), name='doctor-list'),
     path('UIHospitalListView/', UIHospitalListView.as_view(), name='UIHospitalListView-list'),
    ...
    path('hospitaldepartmentspatient/<int:id>/', HospitalDepartmentsViewPatient.as_view(), name='hospital_departments'),
    ...
    # path('chatbot-symptom-checker/', views.chatbot_symptom_checker, name='chatbot_symptom_checker'),
